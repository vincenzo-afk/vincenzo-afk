...
| Contributions (1y) | **2,508** | public contribution graph (parsed, no auth) |
| Followers / Following | **128 / 104** | user profile |
...
<!-- OS:season-note -->
**🚀 NOW PLAYING: SPACE MISSION** — fueled by **2,508 real contributions** across **137 active days**. Season rotates automatically every week: 🚀 SPACE MISSION → 🐍 SNAKE RUN → 👾 PAC-MAN → 🏎️ CODE RACING → 🌌 GALAXY. Next up: **🐍 SNAKE RUN**. The game changes; the grind data never lies.
<!-- /OS:season-note -->
...
FOLLOWERS ×128 ....... +5 XP each
GRIND ×2,508 .... +1 XP each
```
<!-- /OS:level -->
