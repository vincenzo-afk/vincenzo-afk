...
STATUS ............ ● BUILDING (Medibook pushed 1h ago)
...
<!-- OS:skill-mix -->
Live language mix behind this tree (real repo data, Sep 2026): **TypeScript 29 · JavaScript 26 · Python 18 · Rust 3 · HTML 3 · CSS 2 · Dart 2 · Kotlin 2 · Java 1** — 98 public repos. Language counts describe the repos, not skill claims.
<!-- /OS:skill-mix -->
...
<!-- OS:telemetry-table -->
| Metric | Live value (2026-09-19) | Source |
|---|---|---|
| Public repositories | **98** | `api.github.com/users/vincenzo-afk` |
| Stars earned | **2,276** | sum of `stargazers_count` over all repos |
| Contributions (1y) | **2,310** | public contribution graph (parsed, no auth) |
| Followers / Following | **117 / 97** | user profile |
| Forks | **11** | sum of `forks_count` |
| Last push | **Medibook, 1h ago** | repos sorted by `pushed_at` |
| Fresh builds | Medibook · NOVA · vincenzo-afk | last 3 pushes |
...
| 006 | **CypherID** — Blockchain-based secure platform for identity, access control, and digital asset management. | ● BUILDING | [vincenzo-afk/CypherID](https://github.com/vincenzo-afk/CypherID) · 7★ · 7h ago |
...
| 008 | **PrivatePulse-AI** — RAG-powered confidential document intelligence with grounded, cited answers. Hackathon-built. | ● OPERATIONAL | [vincenzo-afk/PrivatePulse-AI](https://github.com/vincenzo-afk/PrivatePulse-AI) · 33★ · 16h ago |
...
<!-- OS:season-note -->
**🌌 NOW PLAYING: GALAXY** — fueled by **2,310 real contributions** across **132 active days**. Season rotates automatically every week: 🚀 SPACE MISSION → 🐍 SNAKE RUN → 👾 PAC-MAN → 🏎️ CODE RACING → 🌌 GALAXY. Next up: **🚀 SPACE MISSION**. The game changes; the grind data never lies.
<!-- /OS:season-note -->
...
REPOS ×98 ............ +20 XP each
STARS ×2,276 ......... +2 XP each
FOLLOWERS ×117 ....... +5 XP each
GRIND ×2,310 .... +1 XP each
```
<!-- /OS:level -->
...
<!-- OS:transmissions -->
```text
18:22  pushed to Medibook
02:48  public activity in Medibook
...
2026
└── 98 public repos, 2200+ stars — search engines in Rust, WiFi sensing, RAG, agent infrastructure

NOW
└── Building systems instead of demos — Medibook, NOVA, vincenzo-afk in active development
```
<!-- /OS:lore -->
...
<!-- OS:top-repos -->
Top repositories by stars (live, 2026-09-19) — click any row to warp in:
...
```
────────────────────────────────────────
BK.DEV SYSTEM · VERSION 26.09.19
LAST SYNCHRONIZED 2026-09-19 UTC · SOURCE api.github.com/users/vincenzo-afk
